...
static int HEIGHT = 60; //height of the alert view
...
{
    defaultViewColor = [UIColor colorWithRed:0.1 green: 0.1 blue: 0.1 alpha:1];//%%% default color from slingshot
    
    defaultTextColor = [UIColor whiteColor];
    DEFAULT_TITLE = @"Нет Интернета"; //%%% this text can only be edited if you do not use the pod solution. check the repo's README for more information
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [titleLabel setFont:[UIFont fontWithName:@"ProximaNova-Semibold" size:17.0]];
