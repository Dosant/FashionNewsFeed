...
- (NSMutableArray *)getPosts{
    ...
    NSMutableArray *posts = [NSMutableArray arrayWithObjects: post1, post1, nil];
    return posts;
}
...
- (NSMutableArray *)getCategories{
    ...
    category3.categoryName = @"КОЛЛЕКЦИИ";
    category3.categoryCount = 300;
    category3.categoryLink = @"http://fcollection.by/archives/category/collections";
    category3.categoryMeta = nil;

    FCCategory *category4 = [[FCCategory alloc] init];
    category4.categoryId = 4;
    category4.categoryName = @"ЛИЦА";
    category4.categoryCount = 400;
    category4.categoryLink = @"http://fcollection.by/archives/category/face";
